...
As an example observe ~\ref{fig:k-near}. If someone would have to assign a class (green triangles, blue squares or red circles) to the cross in the figure, they would 
...
As established in the first chapter~\autoref{cha:introduction}, the pursuit of "marginal gains" in high-intensity team sports like basketball requires the continuous development on the mitigation of related 
...
Edge computing and machine learning algorithms—such as Random Forests and Decision Trees—these multimodal wearable systems represent the cutting edge of real-time monitoring~\cite{MachineLearningBasedClassification}. By 
