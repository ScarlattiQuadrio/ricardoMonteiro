...
\section{Project Introduction and Proposition}
...
The National Basketball Association collects statistics through several high definition 3D cameras than can record the whole field. This technology is called SportVU and has been introduced to the league in September of 2013~\cite{basketballFootwork}.

For this project two devices consisting of an Arduino and an \gls{EMG} sensor will be used to collect data. This is an initial design that can be improved by implementing these sensors into an 
...
Even tho another other devices have increased precision and other types of data, in basketball, the only allowed wearables are the ones that can be hidden and won't cause any disturbances 
