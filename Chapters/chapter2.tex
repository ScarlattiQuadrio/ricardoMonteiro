...
For acquiring movement related data the usual methods are through an \gls{IMU}, image capture


\section{\gls{IMU} - Inertial Measurement Unit}
\label{sec:imuT}

An \gls{IMU} is a device consisting of a combination of accelerometers and gyroscopes and sometimes magnetometers tracking motion.
...
\subsubsection{Bluetooth Low Energy - \gls{BLE}}
\label{sssec:bleT}
...
is room for improvement based on the values read for the less experienced players. It was also mentioned that wear of the shoes may have influenced the slight changes observed in the study. 
Each player wore their own shoes and this was pointed as a variable for the plantar pressure measured.
