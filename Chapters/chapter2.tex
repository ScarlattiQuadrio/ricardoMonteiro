...
For acquiring movement related data the usual methods are through an IMU, image capture
...
For gait monitoring through preassure there are several different types of sensors used in wearables that can be separated in five different categories~\cite{smartSocks}:
